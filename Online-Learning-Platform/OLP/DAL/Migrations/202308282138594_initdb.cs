namespace DAL.Migrations
{
    ...
    public partial class initdb : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Feedbacks", "sid", "dbo.Students");
            DropForeignKey("dbo.Feedbacks", "cid", "dbo.Courses");
            ...
            DropIndex("dbo.Feedbacks", new[] { "sid" });
            DropIndex("dbo.Feedbacks", new[] { "cid" });
